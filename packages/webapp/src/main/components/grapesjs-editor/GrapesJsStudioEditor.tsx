...
export const GrapesJsStudioEditor: React.FC = () => {
  ...
  // Helper function to get page options dynamically
  const getPageOptions = (editor: any) => {
  ...
  // Helper function to register button component with link functionality
  const registerButtonComponent = (editor: any) => {
