...
import { LayouterRepository } from '../layouter/layouter-repository';
import { ObjectElementType } from '../../packages/uml-object-diagram';
...
export const UMLElementCommonRepository = {
  ...
  create:
    ...
    async (dispatch) => {
      ...
      // 🎯 IMPORTANT: Trigger layout after element creation
      // This ensures that the render() method is called immediately after drag & drop,
      // allowing proper calculation of dimensions, positions, and display properties
      // (like className for objects). Without this, elements would need a page reload
